...
from engine_rag_v2 import RAGEngine, EngineConfig, DISEASE_RULES
...
st.caption("Uses your repo files: metadata_v2.json + doc_registry.json + faiss_index_v2.bin (V2 setup)")
